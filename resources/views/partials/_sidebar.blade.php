@if(\Illuminate\Support\Facades\Auth::check())
    <nav class="side-navbar">
        ...
        <ul class="list-unstyled">
            <li class="{{Request::is('user/*') ? "active" : " "}}"> <a href="{{route('user.all')}}"><i class="fa fa-user"></i>&nbsp;Users</a></li>
            <li class="{{Request::is('movie/*') ? "active" : " "}}"> <a href="{{route('movie.all')}}"><i class="fa fa-file-movie-o"></i>&nbsp;Movies</a></li>
            ...
            {{--@endif--}}
                {{--<li class="{{Request::is('activity/password/change') ? "active" : " "}}"> <a href="{{route('passwordChange')}}"><i class="fa fa-key"></i>&nbsp;Change Password</a></li>--}}
